...
use Tomgrohl\Laravel\Form\Element\Element;
use Tomgrohl\Laravel\Form\Exception\InvalidDataTransformerException;
use Tomgrohl\Laravel\Form\Element\CheckableInterface;
...
class Form extends AttributeBuilder implements FormInterface
{
    ...
    public function isValid()
    {
        ...
        return false === $this->getValidator()->fails();
    }
